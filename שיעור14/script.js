...
function displayImages()
{
    ...
    {   
      ...
      <div class="col">
          ...
          <img class="card-img" src="${_movies[i].imageUrl}">
            <div class="card-body">
...
function sendEmail() {
  ...
  Email.send({
      ...
      Username: "ariel.meirson@gmail.com",
      Password: "1229C5FB42977C8C68847AF5206A15ABDE2B",
      From: "ariel.meirson@gmail.com",
      To: "ariel.meirson@gmail.com",
